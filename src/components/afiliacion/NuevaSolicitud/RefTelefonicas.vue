<template >
  <div class="Ref. Telefonicas">

    <v-layout row  justify-center>
    <v-dialog v-model="open" persistent max-width="900" >
      <v-card  >
        <v-card-title>
          <span class="headline">Ref. Telefonicas</span>
        </v-card-title>
        <v-card-text>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" flat @click="close(5)">Close</v-btn>
          <v-btn color="blue darken-1" flat @click="save(5)">Save</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-layout>
